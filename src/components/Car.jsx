  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-4, 0, 13]}>
        ...
        <mesh geometry={nodes.Object_12.geometry} material={sideLightMaterial} />
        {/* Side light spotlight back */}
    
      </group>
      <group ref={wheelRefs.frontRight} position={[1.672, -0.25, -2.991]} scale={[0.26, 0.307, 0.26]}>
        ...
        <mesh geometry={nodes.Object_16.geometry} material={materials['Material.020']} />
      </group>
      <group ref={wheelRefs.frontLeft} position={[-1.607, -0.25, -2.991]} rotation={[-Math.PI, 0, -Math.PI]} scale={[0.26, 0.307, 0.26]}>
        ...
        <mesh geometry={nodes.Object_20.geometry} material={materials['Material.020']} />
      </group>
      <group ref={wheelRefs.backRight} position={[1.672, -0.266, 2.523]} scale={[0.26, 0.307, 0.26]}>
        ...
        <mesh geometry={nodes.Object_24.geometry} material={materials['Material.020']} />
      </group>
      <group ref={wheelRefs.backLeft} position={[-1.607, -0.266, 2.523]} rotation={[-Math.PI, 0, -Math.PI]} scale={[0.26, 0.307, 0.26]}>
        <mesh geometry={nodes.Object_26.geometry} material={materials['Material.003']} />
        <mesh geometry={nodes.Object_27.geometry} material={materials['Material.004']} />
        <mesh geometry={nodes.Object_28.geometry} material={materials['Material.020']} />
      </group>
      <group scale={[0.26, 0.307, 0.26]}>
        <mesh geometry={nodes.Object_30.geometry} material={materials.fpostersmallwall_textureproduct750x1000} />
        <mesh geometry={nodes.Object_31.geometry} material={materials['Material.010']} />
      </group>
      <group scale={[0.26, 0.307, 0.26]}>
        <mesh geometry={nodes.Object_33.geometry} material={materials.fpostersmallwall_textureproduct750x1000} />
        <mesh geometry={nodes.Object_34.geometry} material={materials['Material.010']} />
      </group>
      <group position={[0.014, 0, 0]} scale={[0.26, 0.307, 0.26]}>
        <mesh geometry={nodes.Object_38.geometry} material={materials['tofu_shop.002']} />
        <mesh geometry={nodes.Object_39.geometry} material={materials['Material.034']} />
      </group>
      <mesh geometry={nodes.Object_36.geometry} material={materials['Material.002']} scale={[0.26, 0.307, 0.26]} />
    </group>
  )
}
