...
export default function Model(props) {
  ...
  const optimizedMaterials = useMemo(() => ({
    Car_paint: new THREE.MeshLambertMaterial({ 
      color: materials.Car_paint?.color || 0xffffff 
    }),
